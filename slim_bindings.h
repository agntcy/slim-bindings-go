...
#endif
#ifndef UNIFFI_FFIDEF_UNIFFI_SLIM_BINDINGS_FN_FUNC_INITIALIZE_FROM_CONFIG_WITH_ERROR
#define UNIFFI_FFIDEF_UNIFFI_SLIM_BINDINGS_FN_FUNC_INITIALIZE_FROM_CONFIG_WITH_ERROR
void uniffi_slim_bindings_fn_func_initialize_from_config_with_error(RustBuffer config_path, RustCallStatus *out_status
);
#endif
...
#endif
#ifndef UNIFFI_FFIDEF_UNIFFI_SLIM_BINDINGS_CHECKSUM_FUNC_INITIALIZE_FROM_CONFIG_WITH_ERROR
#define UNIFFI_FFIDEF_UNIFFI_SLIM_BINDINGS_CHECKSUM_FUNC_INITIALIZE_FROM_CONFIG_WITH_ERROR
uint16_t uniffi_slim_bindings_checksum_func_initialize_from_config_with_error(void
...
#endif
#ifndef UNIFFI_FFIDEF_UNIFFI_SLIM_BINDINGS_CHECKSUM_CONSTRUCTOR_CHANNEL_NEW_GROUP
#define UNIFFI_FFIDEF_UNIFFI_SLIM_BINDINGS_CHECKSUM_CONSTRUCTOR_CHANNEL_NEW_GROUP
uint16_t uniffi_slim_bindings_checksum_constructor_channel_new_group(void
    
);
#endif
#ifndef UNIFFI_FFIDEF_UNIFFI_SLIM_BINDINGS_CHECKSUM_CONSTRUCTOR_CHANNEL_NEW_GROUP_WITH_CONNECTION
#define UNIFFI_FFIDEF_UNIFFI_SLIM_BINDINGS_CHECKSUM_CONSTRUCTOR_CHANNEL_NEW_GROUP_WITH_CONNECTION
uint16_t uniffi_slim_bindings_checksum_constructor_channel_new_group_with_connection(void
